...
this.CentreWindow2=CentreWindow2;
windows.push(this);
if(height!==false)
{
...
{
document.getElementById('windowspan').innerHTML+="<div id='"+this.divname+"' style='display:none; border:solid black 1px;position:absolute; top:"+top+";left:"+left+"; z-index:"+zindex+"; background-color:"+bgcolour+";width:"+width+";'><div id='"+this.name+"titlediv' onmousedown='"+this.name+".HoldsMouse();' onmouseup='"+this.name+".moveme=false;' style='position:relative; width:"+width+"; height:20; cursor:move; background-color:"+titlecolour+";'><span id='"+this.name+"titlespan' style='float:left;'>"+title+"<\/span><span style='float:right; cursor:hand; cursor:pointer;' onClick='"+this.name+".CloseWindow();"+onclose+"'>X<\/span><\/div><div id='"+this.name+"content' style='padding:"+padding+";color:black;'>"+contents+"<\/div><\/div>"
}
}
