...
function entity(state,name,x,y,width,height,mass,colour,type,vx,vy,fx,fy,hard,sticky,shape,visible,gametype,elastic,onclickstuff)
{
...
new entity(1,'stringball'+stringballs.length,(startx+1*dx),(starty+1*dy),dotsize,dotsize,5,[0,0,0],0,0,0,0,0,true,false,0,true,1,0.95,'');
stringballs.push(1)
...
{
new entity(1,'stringball'+stringballs.length,(startx+d*dx),(starty+d*dy),dotsize,dotsize,5,[0,0,0],0,0,0,0,0,true,false,0,true,1,0.95,'');
stringballs.push(1)
...
{
if(wholeworld[this.arraypos+1].colour[0]!==this.colour[0] || wholeworld[this.arraypos+1].colour[1]!==this.colour[1] || wholeworld[this.arraypos+1].colour[2]!==this.colour[2])
{
