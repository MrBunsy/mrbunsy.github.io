...
springlines[this.arraypos].state=0;
...
new entity(1,'stringball'+stringballs.length,(startx+1*dx),(starty+1*dy),dotsize,dotsize,5,'black',0,0,0,0,0,true,false,0,true,1,0.95,'');
stringballs.push(1)
...
{
new entity(1,'stringball'+stringballs.length,(startx+d*dx),(starty+d*dy),dotsize,dotsize,5,'black',0,0,0,0,0,true,false,0,true,1,0.95,'');
stringballs.push(1)
