...
new entity(1,'stringball'+stringballs.length,(startx+1*dx),(starty+1*dy),dotsize,dotsize,5,false,0,0,0,0,0,true,false,0,'background-color:black;clip:rect(0,'+dotsize+'px,'+dotsize+'px,0);',2,0.95);
stringballs.push(1)

connect(one,wholeworld.length-1,stringstrength,density,0)

for(var d=2;d<dots;d++)
{
new entity(1,'stringball'+stringballs.length,(startx+d*dx),(starty+d*dy),dotsize,dotsize,5,false,0,0,0,0,0,true,false,0,'background-color:black;clip:rect(0,'+dotsize+'px,'+dotsize+'px,0);',2,0.95);
stringballs.push(1)
connect(wholeworld.length-2,wholeworld.length-1,stringstrength,density,0)
}

connect(wholeworld.length-1,two,stringstrength,density,0)
