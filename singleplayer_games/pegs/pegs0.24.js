...
<div id="pegsdiv"><span id="pegsspan"></span><canvas id="pegscanvas" width="500" height="500"></canvas></div>
<script src="pegs0.24.js" type="text/javascript"></script>

*/
// Not quite as simple as I'd first hoped - but you can blame IE for that.
// Excanvas can't detect a canvas added to the page with javascript, and I don't want to delve into it to add that functionality.
