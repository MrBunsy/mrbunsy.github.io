...
{
//squareX=(squareX*1+square.x*1+square.width/2)/2
//squareY=(squareY*1+square.y*1+square.height/2)/2

//squareX=(squareX+square.x)/2
//squareY=(squareY+square.y)/2

/*
polycentreX=(polycentreX+poly.x)/2
polycentreY=(polycentreY+poly.y)/2

newangle=(poly.angle+newangle)/2
*/
//alert(poly.Rs.length)
...
//alert(polyx+','+polyy+" squarex="+squareX+" squarey="+squareY)
//if(rightx1 > x2 && x1 < (x2+w2) && y1 < (y2+h2) && bottomy1 > y2)
...
PCpointy=polyy;
/*
var diffx=squareX-polyx;
var diffy=squareY-polyy;

var polynewXdiff=polycentreX-poly.x;
var polynewYdiff=polycentreY-poly.y;
var polynewanglefidd

var squarenewXdiff=squareX-square.x;
var squarenewYdiff=squareY-square.y;
*/
...
//this doesn;t work.  Need to find which line of square is nearest a point - FP3 vector stuff?

/*
if(Math.abs(diffx)>Math.abs(diffy))
{//point is closer to side of square, rather than top/bottom
PCnormalx=1;
PCnormaly=0;
if(diffx>0){PCnormalx*=-1};
}else{//close to top/bottom.
PCnormalx=0;
PCnormaly=1;
if(diffy>0){PCnormaly*=-1};
}
*/
//alert(oldpointY+" "+oldpointX)
...
//treating squares as huge - should be safe as movable squares should no-longer have a need due to polygons.
//if()
