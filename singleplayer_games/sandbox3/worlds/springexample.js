...
connect(temparray[1].arraypos,temparray[2].arraypos,10000,false,1,0,true)
connect(temparray[3].arraypos,temparray[0].arraypos,10000,false,1,0,true)
...
temparray[4]=new entity(1,'ball',400,350,50,50,50,'red',0,0,200,0,0,true,false,0,true,1,0.95,'','balls/red.gif');
...
connect(temparray[6].arraypos,temparray[4].arraypos,1000,false,1,0,true)
