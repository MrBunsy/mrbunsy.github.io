...
PCaI=wholeworld[us].mass*( 100*100 + 100*100)/12;
PCbI=wholeworld[them].mass*( 100*100 + 100*100)/12;
...
/*
if(!uspoly)
{//switch about if 'we' are the circle
var oldus=us;
var oldthem=them;
us=oldthem;
them=oldus;
...
theirnewvx= wholeworld[us].vx - PCi*PCnormal[0]/wholeworld[them].mass
theirnewvy= wholeworld[us].vy - PCi*PCnormal[1]/wholeworld[them].mass
theirnewvw = wholeworld[us].vw - PCi*(PCRap[0]*PCnormal[1] - PCRap[1]*PCnormal[0])/PCbI
