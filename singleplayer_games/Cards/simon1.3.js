// Javascript Simple Simon Solitaire 1.3
...
document.getElementById('cardsdiv').innerHTML+='<div id="menudiv" style="border:solid black 1px;background-color:#78beeb;width:'+parseFloat(document.getElementById('cardsdiv').style.width)+';height:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.04+';font-size:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.03+'px;"><span style="float:left;margin-left:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.01+'px;"><span onClick="Simon.confirmNewGame();">New Game</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span onClick="Simon.undo();">Undo</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span onClick="Simon.help();">Help</span></span><span style="float:right;margin-right:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.01+'px;" onClick="Simon.about();">Simple Simon</span></div><span id="cardsspan"></span><span style="display:none">this makes it work in IE for some bizzare reason</span><canvas id="cardscanvas" width="'+(parseFloat(document.getElementById('cardsdiv').style.width))+'" height="'+(parseFloat(document.getElementById('cardsdiv').style.height)*0.96)+'"></canvas><div id="cardsdiv2"><canvas style="display:none;" id="cardsminicanvas" width="'+(parseFloat(document.getElementById('cardsdiv').style.width)*0.1)+'" height="'+(parseFloat(document.getElementById('cardsdiv').style.height)*0.75)+'"></canvas></div>'
...
Simon.about=function()
  {
	if(!Simon.won)
  	...
  	new Cards.text('<center>Simple Simon 1.3<br><br><span style="font-size:'+Cards.width*0.03+'px;">&copy; Luke Wallin 2008<br><br>www.lukewallin.co.uk</a></span></center>','#000000',1,0.25,0,0.36,0.05);
...
Simon.checkMice=function()
  ...
  if(Simon.drag!==false && Cards.checkCount%2==0)
	  {
		Cards.minicanvastag.style.left=Cards.mouse[0]+Simon.dragDiff[0];
		Cards.minicanvastag.style.top=Cards.mouse[1]+Simon.dragDiff[1];
		}
	Cards.checkCount++
  }
...
Simon.animateDrawMiniCanvas=function(stackheight)
  ...
  Cards.minicanvastag.style.left=(Simon.animatePile*0.0909+0.00545)*Cards.width;
  Cards.minicanvastag.style.top=(0.00808+((0.035)*Cards.width/Cards.height)*Simon.animateCard)*Cards.height;
  Cards.minicanvastag.style.display='block';
	}
...
Simon.animateStack=function()
  {
	if(Simon.animateStep<21)
	...
	else if(Simon.animateStep<40)
	  {
		...
		dx=(newx-oldx)/20;
		dy=(newy-oldy)/20;
		Cards.minicanvastag.style.left=Math.round(oldx+dx*(Simon.animateStep-20))
  	Cards.minicanvastag.style.top=Math.round(oldy+dy*(Simon.animateStep-20))
		}
	else
	  {
		Cards.minicanvastag.style.display='none';
