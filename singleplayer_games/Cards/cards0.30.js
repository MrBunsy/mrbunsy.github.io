...
Cards.load=function()
  ...
  Cards.oldmouse=new Array(2);
	...
	Cards.menuDiv=document.getElementById('menudiv');
	...
	if(!Cards.IE || true)  	{
	  ...
	  {
		Cards.canvastag.style.position="absolute";
  	Cards.minicanvastag.style.position="absolute";
		}
	
	Cards.minicanvastag.style.zIndex=2;
	Cards.noSelect(Cards.minicanvastag);
	Cards.noSelect(Cards.menuDiv);
	
	//div encasing everything except the menubar
	Cards.div2=document.getElementById('cardsdiv2');
  Cards.div2.style.position="absolute";
  Cards.div2.style.height=Cards.height*0.96+2;
  Cards.div2.style.width=Cards.width+2;
  //means cards can't leave the div!
  Cards.div2.style.overflow="hidden";
	Cards.div2.style.clip="rect(1px,"+(Cards.width+1)+"px,"+(Cards.height*0.96+1)+"px,1px)";
...
Cards.drawBox=function(x,y,width,height,colour1,colour2,where)
  {
	...
	cardthick=1//Math.ceil(0.01*width*Cards.width)
