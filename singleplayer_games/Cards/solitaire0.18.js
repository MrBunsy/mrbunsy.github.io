...
document.getElementById('cardsdiv').innerHTML+='<div id="menudiv" style="border:solid black 1px;background-color:#78beeb;width:'+parseFloat(document.getElementById('cardsdiv').style.width)+';height:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.04+';font-size:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.03+'px;"><span style="float:left;margin-left:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.01+'px;" onClick="Solitaire.confirmNewGame();">New Game</span><span style="float:right;margin-right:'+parseFloat(document.getElementById('cardsdiv').style.height)*0.01+'px;" onClick="Solitaire.about();">Solitaire</span></div><span id="cardsspan"></span><span style="display:none">this makes it work in IE for some bizzare reason</span><canvas id="cardscanvas" width="'+(parseFloat(document.getElementById('cardsdiv').style.width))+'" height="'+(parseFloat(document.getElementById('cardsdiv').style.height)*0.96)+'"></canvas><div id="cardsdiv2"><canvas style="display:none;" id="cardsminicanvas" width="'+(parseFloat(document.getElementById('cardsdiv').style.width)*0.13)+'" height="'+(parseFloat(document.getElementById('cardsdiv').style.height)*0.66)+'"></canvas></div>'
...
Solitaire.about=function()
  {
	...
	new Cards.text('<center>Solitaire 1.8<br><br><span style="font-size:'+Cards.width*0.03+'px;">&copy; Luke Wallin 2008<br><br>www.lukewallin.co.uk</a></span></center>','#000000',1,0.25,0,0.36,0.05);
...
Solitaire.checkMice=function()
  ...
  if(Solitaire.drag!==false && Cards.checkCount%2==0)
	  {
		Cards.minicanvastag.style.left=Cards.mouse[0]+Solitaire.dragDiff[0];
		Cards.minicanvastag.style.top=Cards.mouse[1]+Solitaire.dragDiff[1];
		}
	Cards.checkCount++
  }
...
Solitaire.win=function()
  ...
  Cards.minicanvastag.style.left=Solitaire.flyPos[0]*Cards.width;
	Cards.minicanvastag.style.top=Solitaire.flyPos[1]*Cards.height;
  Cards.minicanvastag.style.display='block';
	}
	...
	Solitaire.winFunc=function()
  {
	...
	if(!Cards.IE)
	 ...
	 {
	 Cards.minicanvastag.style.left=newPos[0]*Cards.width;
	 Cards.minicanvastag.style.top=newPos[1]*Cards.height;
