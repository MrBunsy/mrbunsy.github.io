...
case "E":if(lastkeypressed=='D'){lastkeypressed='E';}else if(lastkeypressed=='M'){lastkeypressed=false;statdemo=true;demo=true;}else{lastkeypressed=false;}break;
...
case "T":lastkeypressed='T';break;
case "I":if(lastkeypressed=='T'){lastkeypressed='I';}else{lastkeypressed=false;}break;

case "M":if(lastkeypressed=='E' || lastkeypressed=='I'){lastkeypressed='M';}else{lastkeypressed=false;}break;
