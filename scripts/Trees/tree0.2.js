...
TreeObject.tree=function(x,y,iterations,branchings,size,steps,thick,ratio,colour,angle)
  {
	this.root=[x,y];
  			...
  			if(TreeObject.trees[t].branches[i].alive)
    			{
  				...
  				//for each branch that is alive, draw a bit more.
					...
					//alert("rgb("+(TreeObject.trees[t].colour[0][0]+TreeObject.trees[t].dcolour[0]*TreeObject.trees[t].iteration)+","+(TreeObject.trees[t].colour[0][1]+TreeObject.trees[t].dcolour[1]*TreeObject.trees[t].iteration)+","+(TreeObject.trees[t].colour[0][2]+TreeObject.trees[t].dcolour[2]*TreeObject.trees[t].iteration)+")")
...
new TreeObject.tree(250,400,5,4,100,5,[10,0.5],0.8,[ [204,153,0] , [50,200,0] ] , 1);