...
var Spirograph = function(canvas){//},canvas2){
    ...
    this.update = function(){
        //this.time+=0.02;
        this.innerGear.adjustAngle(0.001);
        this.outerGear.adjustAngle(0.001);
        this.innerGear2.adjustAngle(-0.005);
        
        this.fixedGear.adjustAngle(-0.002);
        //this.
    ...
    this.thread = setInterval(function(){self.update.call(self)},10);
}