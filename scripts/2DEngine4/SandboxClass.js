 ...
 * @author Luke
 */
var SandboxClass=function(controlsDiv,canvasTag,canvas,canvasSize,worldSize,gravity,friction,fps,miniMapCanvasTag,miniMapCanvas,miniMapSize,url)
{
	var thisObject=this;
	...
	this.MessageWindow=function(html,size){
		...
		thisObject._controlsDiv.appendChild(this.messageDiv);
	...
	this._buildMessageWindows=function(){
		...
		this._nothingToSaveMessage = new thisObject.MessageWindow("You haven't created anything to save yet.",0.5);
		
		this._saveMessage=new thisObject.MessageWindow("",0.5);
		...
		this._loadMessage=new thisObject.MessageWindow("",0.5);
		...
		this._springMessage=new thisObject.MessageWindow("<h3>Spring Options</h3>",0.5);
		var html= "<ul>";
		...
		this._newShapeMessage=new thisObject.MessageWindow("<h3>New Shape Options</h3>",0.5);
		...
		this._worldOptionsMessage=new thisObject.MessageWindow("<h3>World Options</h3>",0.5);
...
//		html+="<li><input type='button' name='play' value='Play' /></li>";
		...
		html+="<li><label>----<input type='button' value='New Shape Options' name='newShapeOptions' /></li>";
...
//		html+="<li></li>";
		...
		html+="<li><label>----<input type='button' value='Spring Options' name='springOptions' /></li>";
		...
		html+="<li><input type='button' name='clearWorld' value='Clear World' /></li>";
		html+="</ul>";
