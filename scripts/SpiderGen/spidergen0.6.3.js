...
SpiderGen.load=function()
  ...
  if (SpiderGen.canvastag.getContext)
	...
	new SpiderGen.spider(-100,1,1,[250,250]);
  			...
  			break;
				case 1://darwinia spider walking
				  ...
				  //draw top segments of body
					...
					//top of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/4);
					//top mid of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/8);
					//top right of head
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*0.4 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*0.1);
					}
					...
					{
					//top of body
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/4);
					//top right of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.75 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*0.6);
					//top mid right of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.825 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*0.3);
					//mid top of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/8);
					//top of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/4);
					...
					{
					//mid top of body
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.3 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*3/8);
					//top mid right of body
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*1.825 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*0.3);
					//right of body
