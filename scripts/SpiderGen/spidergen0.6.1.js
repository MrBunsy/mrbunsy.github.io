  			...
  			break;
				case 1://darwinia spider walking
				  ...
				  //SpiderGen.canvas.beginPath();
					//left of little blob
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//top of little blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/2);
					//right of little blob/left of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//back to left of little blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					
					//right of little blob
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//top of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size*7/8);
					//right of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*2.5 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/2);
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//SpiderGen.canvas.fill();
					}
					
					var middleFunc1=function()
					{
					//draw middle segments
					//SpiderGen.canvas.beginPath();
					//top left of little blob
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//top right of little blob/left of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//bottom right of little blob/left of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1]);
					//bottom left of little blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1]);
					//top left of little blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					...
					//top right of little blob/left of big blob
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/4);
					//top right of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*2.5 , SpiderGen.spiders[i].pos[1] - SpiderGen.spiders[i].size/2);
					//bottom right of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size*2.5 , SpiderGen.spiders[i].pos[1]);
					//bottom right of little blob/left of big blob
					SpiderGen.canvas.lineTo(SpiderGen.spiders[i].pos[0] + SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1]);
					//SpiderGen.canvas.fill();
					}
					
					var middleFunc2=function()
					{
					//draw middle segments
					//SpiderGen.canvas.beginPath();
					//top left of little blob
					...
					var bottomFunc=function()
					{
					//bottom top segments of body
				  //SpiderGen.canvas.beginPath();
					//left of little blob
					SpiderGen.canvas.moveTo(SpiderGen.spiders[i].pos[0] - SpiderGen.spiders[i].size/2 , SpiderGen.spiders[i].pos[1] + SpiderGen.spiders[i].size/4);
					//top of little blob
					...
					SpiderGen.canvas.fillStyle="rgb(220,0,0)";//brigher red
					SpiderGen.canvas.beginPath();
					middleFunc1();
					middleFunc2();
					bottomFunc();
